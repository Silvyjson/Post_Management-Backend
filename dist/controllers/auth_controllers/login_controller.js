...
var handleLogin = exports.handleLogin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, password, user, isMatch, token, _user$toObject, _, safeUser;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 14:
          ...
          _user$toObject = user.toObject(), _ = _user$toObject.password, safeUser = _objectWithoutProperties(_user$toObject, _excluded);
