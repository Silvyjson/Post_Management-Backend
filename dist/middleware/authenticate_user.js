...
var AuthenticateUser = exports.AuthenticateUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$headers$authoriz, token, secret, verifiedToken, user;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          return _context.abrupt("return", res.status(500).json({
            message: "JWT token secret is not defined"
          }));
        case 7:
          verifiedToken = _jsonwebtoken["default"].verify(token, secret);
          _context.next = 10;
          return _user_model["default"].findById(verifiedToken.userId);
        case 10:
          user = _context.sent;
          if (user) {
            _context.next = 13;
